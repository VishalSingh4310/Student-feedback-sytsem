...
$sql ="SELECT username,email,phone FROM faculty WHERE email= '$h1'";
...
Problem Solving :
<div class="progress">
  <div class="progress-bar bg-danger" role="progressbar" style="width: <?php echo$avgf?>%" aria-valuenow="<?php echo $avgf?>" aria-valuemin="0" aria-valuemax="50"><?php echo $avgf?>%</div>
</div>
</div>
</div>
